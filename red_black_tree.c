...
{   
    ...
    RB_insert(cardNums, 13);
    RB_insert(cardNums, 1);
    RB_insert(cardNums, 25);
    RB_insert(cardNums, 17); 
    RB_insert(cardNums, 11);   
    RB_insert(cardNums, 22);
    RB_insert(cardNums, 6);
    RB_insert(cardNums, 27);  
    RB_insert(cardNums, 15);
    RB_insert(cardNums, 8);    
